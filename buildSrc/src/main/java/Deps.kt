object Libs {
    ...
    const val navigationSafeArgsPlugin = "androidx.navigation:navigation-safe-args-gradle-plugin:2.5.3"
    const val junit5Plugin = "de.mannodermaus.gradle.plugins:android-junit5:1.8.2.1"
